...
const app = new Hono()
    .get("/", clerkMiddleware(), zValidator("query", z.object({from: z.string().optional(), to: z.string().optional(),accountId: z.string().optional()})),
        async (c) => {
            ...
            // calculate summary including the period before that
            ...
            const category = await db
                ...
                // check summary of each transaction individually for the day
            ...
            return c.json({ currentPeriod, lastPeriod, incomeChange, expensesChange, remainingChange, finalCategories, activeDays })
        },
    )
